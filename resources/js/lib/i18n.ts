...
export const en = {
  ...
  'shell.credit': 'API Dock — a Laravel API documentation package by Levent Acar.',
  'shell.versionTitle': 'Installed API Dock version',
  'shell.creditLink': 'lvntr.dev',
  ...
  'tryIt.copyResponseBody': 'Copy response body',
  'tryIt.expandResponseBody': 'Expand response body',
...
export const tr: Record<MessageKey, string> = {
  ...
  'shell.credit': 'API Dock — Levent Acar tarafından geliştirilen Laravel API dokümantasyon paketi.',
  'shell.versionTitle': 'Kurulu API Dock sürümü',
  'shell.creditLink': 'lvntr.dev',
  'shell.language': 'Dil',
  'shell.theme': 'Tema',
  ...
  'tryIt.copyResponseBody': 'Yanıt gövdesini kopyala',
  'tryIt.expandResponseBody': 'Yanıt gövdesini büyüt',
